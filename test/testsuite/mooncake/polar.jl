...
Test the Mooncake AD rule for `left_polar` and its in-place variant. Only runs
...
Test the Mooncake AD rule for `right_polar` and its in-place variant. Only runs
