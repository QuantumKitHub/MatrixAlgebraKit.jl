...
Test the Mooncake AD rule for `qr_compact` and its in-place variant.
"""
...
Test the Mooncake AD rule for `qr_full` and its in-place variant.
"""
...
Test the Mooncake AD rule for `qr_null` and its in-place variant.
"""
